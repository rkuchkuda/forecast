...
function insertWeatherData(data){
    ...
    $('.sidebar-forecast-open.second-day').html('<div class="side-temp">' + Math.round(data.list[0+1].temp.day) + '&deg</div> <div class="side-forecast-img"> <img src="img/weather-img/white/' + data.list[0+1].weather[0].icon + '.png" alt="weather icon"> </div> <p class="side-day">' + secondDay + '</p>');
    ...
    $('.sidebar-forecast-open.third-day').html('<div class="side-temp">' + Math.round(data.list[0+2].temp.day) + '&deg</div> <div class="side-forecast-img"> <img src="img/weather-img/white/' + data.list[0+2].weather[0].icon + '.png" alt="weather icon"> </div> <p class="side-day">' + thirdDay + '</p>');
    $('.sidebar-forecast-close.third-day').html('<img src="img/weather-img/white/' + data.list[0+2].weather[0].icon + '.png" alt="weather icon"> <div class="side-data-sm">' + thirdDateSmall + '</div>');
    $('.sidebar-forecast-open.forth-day').html('<div class="side-temp">' + Math.round(data.list[0+3].temp.day) + '&deg</div> <div class="side-forecast-img"> <img src="img/weather-img/white/' + data.list[0+3].weather[0].icon + '.png" alt="weather icon"> </div> <p class="side-day">' + fourthDay + '</p>');
    $('.sidebar-forecast-close.forth-day').html('<img src="img/weather-img/white/' + data.list[0+3].weather[0].icon + '.png" alt="weather icon"> <div class="side-data-sm">' + fourthDateSmall + '</div>');
	...
	$('#chart-humidity-num').html('<div class="humidity-num-trgl"></div><div class="humidity-num">' + data.list[0].humidity + '%' + '</div>');
	//////////////
	$('#chart-wind-num').html('<div class="wind-num-trgl"></div><div class="wind-num">' + data.list[0].speed + 'm/s' + '</div>');
	//$('.chart-wind-canvas').find('img').rotate({animateTo:260});
	$("#wind-image").rotate({animateTo:data.list[0].deg});
